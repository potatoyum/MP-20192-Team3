...
public class PharmacyAct extends AppCompatActivity implements OnMapReadyCallback,
...
//
        try {
            ...
            CSVReader reader = new CSVReader(new InputStreamReader(am.open("pharmacy.csv"),"EUC-KR"));
            while(true) {
...
//                        list.add(next[0]);
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( PharmacyAct.this, REQUIRED_PERMISSIONS,
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PharmacyAct.this);
